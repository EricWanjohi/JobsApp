package ke.co.droidsense.jobs.Client;

import java.util.concurrent.TimeUnit;

import ke.co.droidsense.jobs.Interceptor.AccessTokenInterceptor;
import ke.co.droidsense.jobs.Interceptor.AuthInterceptor;
import ke.co.droidsense.jobs.Services.STKPushService;
import okhttp3.OkHttpClient;
import okhttp3.logging.HttpLoggingInterceptor;
import retrofit2.Retrofit;
import retrofit2.converter.gson.GsonConverterFactory;

import static ke.co.droidsense.jobs.Constants.Constants.BASE_URL;
import static ke.co.droidsense.jobs.Constants.Constants.CONNECT_TIMEOUT;
import static ke.co.droidsense.jobs.Constants.Constants.READ_TIMEOUT;
import static ke.co.droidsense.jobs.Constants.Constants.WRITE_TIMEOUT;
